...
\033[1;96m  SCRIPT OWNER    :  ALEY X AHITSHAM
\033[1;95m  NOTE          :  ONLY FOR GANG 
\033[1;94m  HATERS JUST FOLLOW US
\033[1;97m  *********************************
"""
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/aley110/VSG/main/vsg.txt') . text
    if to in r:
